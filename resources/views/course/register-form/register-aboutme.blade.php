<div class="aboutme">
    <div class="form-group form-row d-flex  align-items-center   ">
        ...
        <div class="col-12 d-flex flex-row flex-wrap">
            ...
            <div class="col-12 col-md-4 pt-3 pt-md-0 pl-0">
    ...
    <div class="form-group form-row d-flex align-items-center   ">
        <div class="col-12 d-flex flex-row flex-wrap">
            <div class="col-12 col-lg-6  pt-lg-0 pl-0">
            ...
            <div class="col-12 col-lg-6 pt-3 pt-lg-0  pl-0 ">
    ...
    <div class="form-group form-row d-flex align-items-center   ">
        <div class="col-12 d-flex flex-row flex-wrap">
            ...
            <div class="col-12 col-md-6 pt-3   pl-0 pt-md-0">
