<div class="registerbasic">
    ...
    <div class="form-group form-row d-flex align-items-center   ">
        <div class="col-12 d-flex flex-row">
            <div class="col-lg-3 col-12 offset-0 offset-sm-3 pl-0 ">
                <input type="tel" class="form-control " style="width: 100%" name="telphone" id="telphone" pattern="[0]{1}[0-9]{9}" maxlength="10" aria-describedby="telphone" placeholder="เบอร์โทรศัพท์">
            </div>
            <div class="col-lg-3 col-12 offset-0 offset-sm-0  pl-0 pt-3  pt-sm-0 ">
                <input type="email" class="form-control " style="width: 100%" name="email" id="email" maxlength="40" aria-describedby="emailHelp" placeholder="อีเมลล์">
            </div>
        </div>
    </div>
    <div class="form-group form-row d-flex align-items-center   ">
        <div class="col-12 d-flex flex-row">
            <div class="col-6 offset-3 pl-0">
                <input type="text" class="form-control " style="width: 100%" name="idcard" maxlength="13" id="idcard" pattern="[0-9]{13}" aria-describedby="idcard " placeholder="เลขบัตรประชาชน">
            </div>
        </div>
    </div>
    <div class="form-group form-row d-flex align-items-center   ">
        <div class="col-12 d-flex flex-row">
            <div class="col-6 offset-3 pl-0">
                <input type="date" class="form-control " style="width: 100%" name="birthday" id="birthday" aria-describedby="birthday"  placeholder="วัน/เดือน/ปีเกิด">
            </div>
        </div>
    </div>
